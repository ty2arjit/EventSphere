 ...
 * Wired here for Profile Domain completeness — its expected caller is the
 * Authentication Domain later (e.g. after a verification link is clicked),
 * but it's independently usable via its own endpoint until that domain
 * exists.
 */
